  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        is a new thing in the future, where you can enjoy the virtual world by feeling like it's really real, you can feel what you feel in this metaverse world, because this is really the madness of the metaverse of today, using only <span className="font-extrabold text-white">VR devices</span> you can easily explore the metaverse world you want, turn your dream into reality. Let's explore the madness of the metaverse by scrolling down
      </motion.p>
    </motion.div>
    <motion.img
